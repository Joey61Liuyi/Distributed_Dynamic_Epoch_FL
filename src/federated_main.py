...
class Env(object):
    ...
    def step(self, action):
        ...
        reward = (self.lamda * delta_acc - cost - time_global)/10 #TODO test for the existance of data importance
...
#
#     csvFile1 = open("Greedy_" + "Client_" + str(configs.user_num) + ".csv", 'w', newline='')
#     writer1 = csv.writer(csvFile1)
#
#     accuracies = []
#     payments = []
